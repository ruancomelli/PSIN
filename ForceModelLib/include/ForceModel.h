...
class ForceModel
{
	public:	
		...
		static DoubleVector2D gearCorrector(const DoubleVector2D & predictedVector, const DoubleVector & doubleDerivative, const int predictionOrder, const double dt);
