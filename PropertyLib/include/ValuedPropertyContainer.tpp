...
InterfaceType ValuedPropertyContainer::getValue(const Property<InterfaceType, StoredType> & property) const
{
...
void ValuedPropertyContainer::setProperty(const Property<InterfaceType, StoredType> & property, const implicitInterfaceType & implicitValue )
{
...
template<typename InterfaceType, typename StoredType>
bool ValuedPropertyContainer::checkSetted(const Property<InterfaceType, StoredType> & property)
{
